            ...
            {isAgent ? (
              <div className="mt-2 flex flex-wrap items-end gap-3">
                ...
                <div className="relative">
                  ...
                  />
                  {partnerPhone ? (
                    <div className="mt-1 text-xs text-gray-600 whitespace-normal sm:whitespace-nowrap sm:absolute sm:top-0 sm:left-full sm:ml-2 sm:h-9 sm:flex sm:items-center sm:mt-0">
                      {partnerLoading ? (
