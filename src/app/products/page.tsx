    ...
    <div className={hasToken ? "mx-auto w-full max-w-3xl md:max-w-4xl lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl pt-0 pb-4" : "max-w-3xl mx-auto pt-0 pb-4"}>
      <div className="flex items-center justify-between mb-4" style={{minHeight: '40px'}}>
        ...
        {hasToken ? (
          <Link
            href="/products/new"
            className="px-3 py-2 rounded-md text-sm bg-white text-black border border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 dark:focus:ring-offset-gray-950"
          >
            Создать
          </Link>
        ) : null}
