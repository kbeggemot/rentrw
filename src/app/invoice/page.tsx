    ...
    <div className="max-w-xl mx-auto mt-6 md:mt-8 px-4 md:px-0 pb-10 md:pb-12">
      ...
      <div className="space-y-4 text-sm md:text-base text-gray-700 dark:text-gray-200">
        <p>
          ...
          Оплата проходит через <strong>номинальный счёт,</strong> комиссия сервиса — <strong>1,5%</strong> по РФ, и <strong>3%</strong> для зарубежных оплат.<br />
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-4">
          Требуется регистрация в Рокет Ворке. Комиссия — 1,5% от суммы оплаты по РФ, и 3% для зарубежных оплат. Платёж проводится через номинальный счёт. Автоуплата НПД производится по вашему поручению; ставки НПД 6% применяются согласно законодательству и удерживается перед выплатой.
        </p>
      </div>
    </div>
  );
