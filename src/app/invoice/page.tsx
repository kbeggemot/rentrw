    ...
    <div className="max-w-3xl mx-auto p-4 md:p-6">
      ...
      <div className="space-y-4 text-sm md:text-base text-gray-700 dark:text-gray-200">
        <p>
          ...
          Оплата проходит через <strong>номинальный счёт,</strong> комиссия сервиса — <strong>3%.</strong><br />
        ...
        <div>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>Просто и быстро: счёт и ссылка — за пару минут. Комиссия — 3%.</li>
          </ul>
        </div>
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-4">
          Требуется регистрация в Рокет Ворке. Комиссия — 3% от суммы оплаты. Платёж проводится через номинальный счёт. Автоуплата НПД производится по вашему поручению; ставки НПД 6% применяются согласно законодательству и удерживается перед выплатой.
        </p>
      </div>
    </div>
  );
