...
export async function GET(req: Request, ctx: { params: Promise<{ id?: string }> }) {
  try {
    ...
    y -= 2; // small gap between header and first row
    ...
    const terms: string[] = [
      ...
      'Комиссия составит 1,5% и будет удержена с исполнителя, если у вас с Рокет Ворком не согласованы индивидуальные условия обслуживания.',
